    ...
    for _ in range(retry_count):
        ...
        try:
            ...
            for i in range(len(table) - 1, -1, -1):
                ...
                data = (date, openp, highp, lowp, closep, closep, int(volume))
    ...
    if trading_calender is not None and len(stocks) > 0:
        ...
        if cid < len(trading_calender) - 1:
            ...
            if stocks[-1][0] > next_date:
                stocks.append((next_date, data[4], data[4], data[4], data[4], data[5], 0))
...
def start_stocks(stocks, trading_calender):
    if trading_calender is not None:
        ...
        if cid < len(trading_calender) - 1:
            ...
            close = stocks[0][4]
            price = stocks[0][5]
            stocks.insert(0, (next_date, close, close, close, close, price, 0))
